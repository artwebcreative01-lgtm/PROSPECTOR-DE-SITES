...
| `/publicar` | publica na VPS Hostinger KVM2 (SSH) SOZINHO (publicador automático, sem cPanel) + página-capa da proposta + HTTPS validado |
...
Claude Cowork · extensão Claude in Chrome · conectores Gmail e Google Drive · hospedagem Hostinger KVM2 (plano M+) · Python (para o dashboard e o publicador) · Windows ou Mac.
